...
public class AppListener implements ServletContextListener {
    ...
    public static final String URL = "jdbc:sqlite:hotelapp.db";
    ...
    public void contextInitialized(ServletContextEvent sce) {
        try {
            ...
            //s.execute("DELETE FROM customers_stays");
            ...
            if(User.getUsers().isEmpty()){
                ...
                User.insertUser("fulano", "Fulano da Silva", "FUNCIONARIO", "1234");
                initializeLog += "Fulano added; ";
            }
            //Customer
            initializeLog += "Creating CustomerStay table if not exists...";
            s.execute(CustomerStay.getCreateStatement());
            initializeLog += "done.";
            s.close();
            c.close();
        } catch (Exception ex) {
